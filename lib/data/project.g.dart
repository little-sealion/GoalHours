...
const ProjectSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'goalMinutes': IndexSchema(
      id: -1902096877385477830,
      name: r'goalMinutes',
      unique: false,
      replace: false,
      properties: [
...
Project _projectDeserialize(
  ...
  object.createdAtUtc = reader.readDateTime(offsets[2]);
...
extension ProjectQueryWhereSort on QueryBuilder<Project, Project, QWhere> {
  ...
  QueryBuilder<Project, Project, QAfterWhere> anyGoalMinutes() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterWhere> anyArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension ProjectQueryWhere on QueryBuilder<Project, Project, QWhereClause> {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> goalMinutesEqualTo(
      int goalMinutes) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'goalMinutes',
        value: [goalMinutes],
      ));
    });
  }

  QueryBuilder<Project, Project, QAfterWhereClause> goalMinutesNotEqualTo(
      int goalMinutes) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> goalMinutesGreaterThan(
    int goalMinutes, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> goalMinutesLessThan(
    int goalMinutes, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> goalMinutesBetween(
    int lowerGoalMinutes,
    int upperGoalMinutes, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> archivedEqualTo(
      bool archived) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> archivedNotEqualTo(
      bool archived) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> archivedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> createdAtUtcEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> createdAtUtcGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> createdAtUtcLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> createdAtUtcBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> goalMinutesEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'goalMinutes',
        value: value,
      ));
    });
  }

  QueryBuilder<Project, Project, QAfterFilterCondition> goalMinutesGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> goalMinutesLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> goalMinutesBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  QueryBuilder<Project, Project, QAfterSortBy> sortByArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'archived', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByArchivedDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByCreatedAtUtc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtUtc', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByCreatedAtUtcDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtUtc', Sort.desc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByGoalMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'goalMinutes', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByGoalMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'goalMinutes', Sort.desc);
    });
  }
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByArchived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'archived', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByArchivedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'archived', Sort.desc);
    });
  }
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByCreatedAtUtc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtUtc', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByCreatedAtUtcDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAtUtc', Sort.desc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByGoalMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'goalMinutes', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByGoalMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'goalMinutes', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByArchived() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByCreatedAtUtc() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'createdAtUtc');
    });
  }

  QueryBuilder<Project, Project, QDistinct> distinctByGoalMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'goalMinutes');
    });
  }
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, bool, QQueryOperations> archivedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, DateTime, QQueryOperations> createdAtUtcProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAtUtc');
    });
  }

  QueryBuilder<Project, int, QQueryOperations> goalMinutesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'goalMinutes');
    });
  }
